...
- [数据库设计过程之逻辑数据库设计](/ReadingNotes/ef76614/#数据库设计过程之逻辑数据库设计)
    ...
    - [(2)E-R图向关系模式的转换](/ReadingNotes/ef76614/#-2-E-R图向关系模式的转换)
        ...
        - [基本转换规则:泛化与具体化实体的转换](/ReadingNotes/ef76614/#基本转换规则-泛化与具体化实体的转换)
            - [方案1](/ReadingNotes/ef76614/#方案1)
                - [方案1](/ReadingNotes/ef76614/#方案1)
            - [方案2](/ReadingNotes/ef76614/#方案2)
                - [方案2](/ReadingNotes/ef76614/#方案2)
        - [基本转换规则:多元联系的转换](/ReadingNotes/ef76614/#基本转换规则-多元联系的转换)
    - [(3)IDEF1X图向关系模式转换](/ReadingNotes/ef76614/#-3-IDEF1X图向关系模式转换)
    - [(4)不正确设计数据库会引发的问题](/ReadingNotes/ef76614/#-4-不正确设计数据库会引发的问题)
        - [冗余](/ReadingNotes/ef76614/#冗余)
        - [删除异常](/ReadingNotes/ef76614/#删除异常)
        - [插入异常](/ReadingNotes/ef76614/#插入异常)
        - [如何避免数据库出现不一致的问题](/ReadingNotes/ef76614/#如何避免数据库出现不一致的问题)
    - [数据库设计理论](/ReadingNotes/ef76614/#数据库设计理论)
        - [数据依赖理论](/ReadingNotes/ef76614/#数据依赖理论)
        - [关系范式理论](/ReadingNotes/ef76614/#关系范式理论)
        - [模式分解理论](/ReadingNotes/ef76614/#模式分解理论)
    - [小结](/ReadingNotes/ef76614/#小结)
        - [数据库设计过程](/ReadingNotes/ef76614/#数据库设计过程)
        - [逻辑数据库设计步骤](/ReadingNotes/ef76614/#逻辑数据库设计步骤)
- [数据库设计过程之物理数据库设计](/ReadingNotes/ef76614/#数据库设计过程之物理数据库设计)
    - [小结](/ReadingNotes/ef76614/#小结)
