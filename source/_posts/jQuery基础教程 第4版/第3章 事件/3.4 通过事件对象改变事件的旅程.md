...
abbrlink: a4e0166f
---
- [3.4 通过事件对象改变事件的旅程](/ReadingNotes/a4e0166f/#3-4-通过事件对象改变事件的旅程)
    - [3.4.1 事件目标](/ReadingNotes/a4e0166f/#3-4-1-事件目标)
    - [3.4.2 停止事件传播](/ReadingNotes/a4e0166f/#3-4-2-停止事件传播)
    - [3.4.3 阻止默认操作](/ReadingNotes/a4e0166f/#3-4-3-阻止默认操作)
    - [3.4.4 事件委托](/ReadingNotes/a4e0166f/#3-4-4-事件委托)
        - [is()与**.hasClass()](/ReadingNotes/a4e0166f/#is-与-hasClass)
    - [3.4.5 使用内置的事件委托功能](/ReadingNotes/a4e0166f/#3-4-5-使用内置的事件委托功能)
