...
abbrlink: b726cd8c
---
- [3.3.3 自然连接](/ReadingNotes/b726cd8c/#3-3-3-自然连接)
    - [笛卡儿积](/ReadingNotes/b726cd8c/#笛卡儿积)
    - [自然连接](/ReadingNotes/b726cd8c/#自然连接)
    - [SQL查询 对于大学中所有讲授课程的**教师**,找出他们的**姓名**以及所讲述的所有**课程标识**](/ReadingNotes/b726cd8c/#SQL查询-对于大学中所有讲授课程的教师,找出他们的姓名以及所讲述的所有课程标识)
        - [之前写法](/ReadingNotes/b726cd8c/#之前写法)
        - [自然连接写法](/ReadingNotes/b726cd8c/#自然连接写法)
    - [from后面可以使用多个自然连接](/ReadingNotes/b726cd8c/#from后面可以使用多个自然连接)
    - [SQL查询 列出**教师**的**名字**以及他们所讲授**课程的名称**](/ReadingNotes/b726cd8c/#SQL查询-列出教师的名字以及他们所讲授课程的名称)
        - [先自然连接 再笛卡儿积](/ReadingNotes/b726cd8c/#先自然连接-再笛卡儿积)
        - [全部自然连接](/ReadingNotes/b726cd8c/#全部自然连接)
- [自然连接和笛卡儿积的区别](/ReadingNotes/b726cd8c/#自然连接和笛卡儿积的区别)
    - [相同点](/ReadingNotes/b726cd8c/#相同点)
    - [不同点](/ReadingNotes/b726cd8c/#不同点)
    - [实例](/ReadingNotes/b726cd8c/#实例)
        - [笛卡尔积结果](/ReadingNotes/b726cd8c/#笛卡尔积结果)
        - [自然连接结果](/ReadingNotes/b726cd8c/#自然连接结果)
