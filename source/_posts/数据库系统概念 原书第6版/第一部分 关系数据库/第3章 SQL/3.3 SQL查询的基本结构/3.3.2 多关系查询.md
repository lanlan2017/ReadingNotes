...
abbrlink: 43da05aa
---
- [3.3.2 多关系查询](/ReadingNotes/43da05aa/#3-3-2-多关系查询)
    - [找出所有**教师**的**姓名**,以及他们**所在系**的**名称**和**系所在建筑的名称**](/ReadingNotes/43da05aa/#找出所有教师的姓名,以及他们所在系的名称和系所在建筑的名称)
        - [如何查询](/ReadingNotes/43da05aa/#如何查询)
        - [对应的SQL语句](/ReadingNotes/43da05aa/#对应的SQL语句)
    - [两个关系中的同名属性要使用关系名作为前缀](/ReadingNotes/43da05aa/#两个关系中的同名属性要使用关系名作为前缀)
    - [不重名的属性不需要关系名作为前缀](/ReadingNotes/43da05aa/#不重名的属性不需要关系名作为前缀)
    - [多个关系查询的**SQL**通用形式](/ReadingNotes/43da05aa/#多个关系查询的SQL通用形式)
    - [select from where三个子句的作用](/ReadingNotes/43da05aa/#select-from-where三个子句的作用)
    - [SQL查询语句格式](/ReadingNotes/43da05aa/#SQL查询语句格式)
    - [查询运算各子句的执行顺序](/ReadingNotes/43da05aa/#查询运算各子句的执行顺序)
    - [form子句得到笛卡尔积](/ReadingNotes/43da05aa/#form子句得到笛卡尔积)
        - [笛卡尔积说明](/ReadingNotes/43da05aa/#笛卡尔积说明)
    - [where子句限制from子句得到的笛卡尔积](/ReadingNotes/43da05aa/#where子句限制from子句得到的笛卡尔积)
    - [理解SQL查询的结果应该是什么样的](/ReadingNotes/43da05aa/#理解SQL查询的结果应该是什么样的)
    - [要设置合适的where](/ReadingNotes/43da05aa/#要设置合适的where)
- [大学数据库模式](/ReadingNotes/43da05aa/#大学数据库模式)
