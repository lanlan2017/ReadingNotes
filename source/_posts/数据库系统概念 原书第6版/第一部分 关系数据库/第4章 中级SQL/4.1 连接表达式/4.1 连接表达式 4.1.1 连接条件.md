...
abbrlink: d4b47bf9
---
- [4.1 连接表达式](/ReadingNotes/d4b47bf9/#4-1-连接表达式)
    - [student关系内容](/ReadingNotes/d4b47bf9/#student关系内容)
    - [takes关系内容](/ReadingNotes/d4b47bf9/#takes关系内容)
- [4.1.1 连接条件](/ReadingNotes/d4b47bf9/#4-1-1-连接条件)
    - [on条件](/ReadingNotes/d4b47bf9/#on条件)
    - [on条件和自然连接的区别](/ReadingNotes/d4b47bf9/#on条件和自然连接的区别)
    - [on条件改成where](/ReadingNotes/d4b47bf9/#on条件改成where)
    - [on条件只显示一次重复的属性 不使用**select ***](/ReadingNotes/d4b47bf9/#on条件只显示一次重复的属性-不使用select-*)
    - [on条件比自然连接功能更强](/ReadingNotes/d4b47bf9/#on条件比自然连接功能更强)
    - [on条件可以使用where替代](/ReadingNotes/d4b47bf9/#on条件可以使用where替代)
    - [on条件的优点](/ReadingNotes/d4b47bf9/#on条件的优点)
