...
abbrlink: ca319795
---
- [4.1.2 外连接](/ReadingNotes/ca319795/#4-1-2-外连接)
    - [外连接不会丢失元组](/ReadingNotes/ca319795/#外连接不会丢失元组)
    - [内连接定义](/ReadingNotes/ca319795/#内连接定义)
    - [外连接定义](/ReadingNotes/ca319795/#外连接定义)
    - [外连接分类](/ReadingNotes/ca319795/#外连接分类)
    - [左外连接运算过程](/ReadingNotes/ca319795/#左外连接运算过程)
        - [实例](/ReadingNotes/ca319795/#实例)
        - [内连接结果](/ReadingNotes/ca319795/#内连接结果)
        - [找出所有一门课程也没有选修的学生](/ReadingNotes/ca319795/#找出所有一门课程也没有选修的学生)
    - [右外连接](/ReadingNotes/ca319795/#右外连接)
        - [实例](/ReadingNotes/ca319795/#实例)
    - [全外连接](/ReadingNotes/ca319795/#全外连接)
        - [实例](/ReadingNotes/ca319795/#实例)
        - [MySQL8.0不支持全外连接](/ReadingNotes/ca319795/#MySQL8-0不支持全外连接)
        - [MySQL中实现全外连接](/ReadingNotes/ca319795/#MySQL中实现全外连接)
        - [左外连接结果](/ReadingNotes/ca319795/#左外连接结果)
        - [右外连接结果](/ReadingNotes/ca319795/#右外连接结果)
        - [全外连接结果](/ReadingNotes/ca319795/#全外连接结果)
    - [on子句和外连接一起使用](/ReadingNotes/ca319795/#on子句和外连接一起使用)
    - [外连接中on子句和where子句](/ReadingNotes/ca319795/#外连接中on子句和where子句)
        - [外连接补空值的条件](/ReadingNotes/ca319795/#外连接补空值的条件)
        - [外连接中on子句和where子句的不同](/ReadingNotes/ca319795/#外连接中on子句和where子句的不同)
    - [小结](/ReadingNotes/ca319795/#小结)
- [使用的表](/ReadingNotes/ca319795/#使用的表)
    - [student关系内容](/ReadingNotes/ca319795/#student关系内容)
    - [takes关系内容](/ReadingNotes/ca319795/#takes关系内容)
